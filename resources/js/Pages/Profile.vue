        ...
        <div class="index">
            <div class="left-side">
                <div class="profile-info">
                    ...
                    <form @submit.prevent="editProfileSubmit()" v-if="isProfileEdit" class="more-info">
                        <div class="param-input">
                            ...
                            <transition name="fade">
                                <p style="margin-top: 5px; font-size: 14px" class="error-message" v-if="formProfileEdit.errors.fullname">{{ formProfileEdit.errors.fullname }}</p>
                            </transition>
                        </div>
                        ...
                        <div class="param-input">
                            ...
                            <transition name="fade">
                                <p style="margin-top: 5px; font-size: 14px" class="error-message" v-if="formProfileEdit.errors.birthday">{{ formProfileEdit.errors.birthday }}</p>
                            </transition>
                        </div>
                        ...
                        <div class="param-input">
                            ...
                            <transition name="fade">
                                <p style="margin-top: 5px; font-size: 14px" class="error-message" v-if="formProfileEdit.errors.geolocation">{{ formProfileEdit.errors.geolocation }}</p>
                            </transition>
                        </div>
                        ...
                        <div class="param-input">
                            ...
                            <transition name="fade">
                                <p style="margin-top: 5px; font-size: 14px" class="error-message" v-if="formProfileEdit.errors.job">{{ formProfileEdit.errors.job }}</p>
                            </transition>
                        </div>
                        ...
                        <div class="param-input" v-for="(link, index) in formProfileEdit.links">
                            <p class="param">
                                ...
                                <input
                                    ...
                                    :class="{ 'error': formProfileEdit.errors.links }"
                                    @focus="formProfileEdit.errors.links = null"
                                    @blur="setURLMask(index)"
                                >
                            </p>
                            <transition name="fade">
                                <p style="margin-top: 5px; font-size: 14px" class="error-message" v-if="formProfileEdit.errors.links">{{ formProfileEdit.errors.links }}</p>
                            </transition>
                        </div>
                        ...
                        <div class="edit-button">
                            ...
                            <a v-if="isMyProfile" @click="closeEditProfile" class="cancel-button">Отмена</a>
                        </div>
                    </form>
