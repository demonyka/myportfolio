<template>
    <div class="profile-info">
        ...
        <Link :href="getProfileURL(author)" class="user-info" v-for="author in authors">
            ...
            <h4>{{ JSON.parse(author.external_data).fullname }}
                <svg v-if="author.verified" style="transform: translateY(4px);" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
